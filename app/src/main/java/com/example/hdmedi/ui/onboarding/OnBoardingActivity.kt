package com.example.hdmedi.ui.onboarding
...
import com.example.hdmedi.ui.onboarding.teacher.TeacherSettingActivity
import com.example.hdmedi.databinding.ActivityOnBoardingBinding
import com.example.hdmedi.HDmediApplication
import com.example.hdmedi.ui.onboarding.login.LoginActivity
    ...
    private fun initNextButton(){
        binding.nextButton.setOnClickListener{
            if(binding.parentButton.isSelected){
                HDmediApplication.preferences.setString("who","parent")
                Intent(this, LoginActivity::class.java).apply {
                    startActivity(this)
                }
            }else{
                HDmediApplication.preferences.setString("who","teacher")
