...
class Result1Fragment : Fragment() {
    ...
    private var totalScore0 = 0
    private var answerArrayList = ArrayList<String>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

//        setFragmentResultListener("myResultKey") {requestKey, bundle ->
//          val  answerArrayList1 = bundle.getStringArrayList("answerArray") as ArrayList<String>
//
//            totalScore = bundle.getInt("totalscore")
//            answerArrayList = answerArrayList1
//            Log.d("answerArrayList", answerArrayList.toString())
//            Log.d("totalScore2", totalScore.toString())
//        }
    }
...
//        val answerArrayList = viewModel.answerArrayList
//
//        Log.d("answerArrayList", answerArrayList.toString())
//
//
...
//        val tttscore = viewModel.TotalScore
//        Log.d("yyyscore", tttscore.toString())
//        Log.d("answerArrayList", answerArrayList.toString())



        totalScore0 = viewModel.TotalScore.value!!
        answerArrayList = viewModel.answerArrayList.value!!

        Log.d("viewModel3", "${totalScore0}, ${answerArrayList}")
        //데이터 넣기
        resultArray.add(resultData("1. 우리 아이가 세세한 부분에서 \n꼼꼼하게 신경쓰는 것을 \n어려워 하나요?","${answerArrayList.get(0)}"))
        resultArray.add(resultData("2. 우리 아이가 손발을 가만히 \n" +
                "두지 못하거나 의자에 앉아서도 몸을 꼼지락 거리나요?","${answerArrayList.get(1)}"))
