...
//    private var totalScore = 0
    ...
    //선택 점수 총합 배열
    private var questionScoreArrayList = ArrayList<Int>()
    //질문 배열
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setFragmentResultListener("totalScore") { requestKey, bundle ->
...
//
//                //질문 변화
//                binding.textQuestion.setText(questionArray.get(questionNum-3))
//
//                //총 점수 변화
////                Log.d("totalScore", totalScore.toString())
//
