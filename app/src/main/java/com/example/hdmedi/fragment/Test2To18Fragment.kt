...
//        setFragmentResultListener("totalScore0" ) { requestKey, bundle ->
//            totalScore = bundle.getInt("bundleKey")
//            Log.d("answer aa", bundle.getString("bundleKey1").toString())
//            answer = bundle.getString("bundleKey1")!!
//            answerArray.add(answer)
//            Log.d("answerArray",answerArray.toString())
//            Log.d("totalScore0",totalScore.toString())
//        }

//        setFragmentResultListener("answer1") {requestKey, bundle ->
//            answerArray.add(bundle.getString("bundelKey")!!)
//            Log.d("answerArray",answerArray.toString())
//        }
...
//
//                if (questionNum <= 18) {
//                    Log.d("questionNum", questionNum.toString())
//
//                    //질문 숫자 변화
//                    binding.textQuestionNum.setText("${questionNum}/18")
//
//                    Log.d("textQuestionNum", questionNum.toString())
//
//                    //progressBar 변화
//
//                    if (questionNum == 3) {
...
//
////                Log.d("textQuestion", questionArray.get(questionNum - 2))
//
//                    //총 점수 변화
...
//
//                    Log.d(
//                        "status", "${questionNum}번 문항 " +
//                                "\n${questionArray.get(questionNum - 2)} " +
//                                "\n${totalScore}"
//                    )
//
//                    isCheck = false
...
//                    //종료 페이지
//
//                    viewModel.answerArrayList = answerArray
//
//                    Log.d("viewModel array", viewModel.answerArrayList.toString())
////                    setFragmentResult("myResultKey", bundleOf("bundleKey4" to answerArray))
...
//                    Log.d(
//                        "status", "" +
//                                "\n${questionArray.get(questionNum - 3)} " +
//                                "\n${totalScore}"
//                    )
//            }
//
...
//        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        totalScore += bundle!!.getInt("score1")

        answerArray.add(bundle.getString("answer1")!!)
...
//                Log.d("totalScore", totalScore.toString())
                    ...
                    viewModel.addArray(answer)

                    Log.d("viewmodel2, ", "${viewModel.TotalScore.value},${viewModel.answerArrayList.value}")
//                    answerArray.add(answer)
                    ...
                    viewModel.addScore(questionScore)
                    viewModel.addArray(answer)
                    Log.d("viewmodel2, ", "${viewModel.TotalScore},${viewModel.answerArrayList}")

                    totalScore += questionScore
                    answerArray.add(answer)
                    Log.d("answerArray", answerArray.toString())
                    Log.d("totalScore1", totalScore.toString())
                    //종료 페이지
...
//                    Log.d("viewModel array", viewModel.answerArrayList.toString())
//                    setFragmentResult("myResultKey", bundleOf("answerArray" to answerArray, "totalscore" to totalScore))
                    val result1Fragment = Result1Fragment()
                    fragmentManager?.beginTransaction()?.apply {
                        replace(R.id.frameLayout, result1Fragment)
                        addToBackStack(null)
